...
import 'package:asnproject_ui/components/icons/icons.dart';
import 'package:asnproject_ui/components/input_fields/input_fields.dart';
...
/// Possible size values for [ASNProjectTextInputField].
enum ASNProjectTextInputFieldSize {
  sm,
  md,
}

/// ASNProject UI's text input field.
///
/// This component was made as closely as possible to [TextFormField].
class ASNProjectTextInputField extends StatefulWidget {
  ...
  /// The suffix icon assets name.
  final IconData? suffixIconAssetName;

  /// The suffix add-on text.
  final String? suffixAddOnText;

  /// The suffux icon asset name displayed when [errorText] is not null.
  ...
  /// The text field size.
  final ASNProjectTextInputFieldSize size;
  ...
  ///
  /// If this property is null, [MaterialStateMouseCursor.textable]
  /// will be used.
  ///
  ...
  const ASNProjectTextInputField({
    super.key,
    this.label,
    this.errorText,
    this.hintText,
    this.enabled = true,
    this.helperText,
    this.size = ASNProjectTextInputFieldSize.md,
    ...
    this.suffixErrorIconAssetName = Icons.circle_notifications,
    this.onTapSuffix,
    this.focusNode,
  ...
  @override
  State<ASNProjectTextInputField> createState() =>
      _ASNProjectTextInputFieldState();
}

class _ASNProjectTextInputFieldState extends State<ASNProjectTextInputField> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.size == ASNProjectTextInputFieldSize.sm) {
    ...
    if (widget.suffixIconAssetName != null) {
      if (widget.enabled && widget.errorText != null) {
        suffixIconColor = ASNProjectColors.red;
        suffixIcon = widget.suffixErrorIconAssetName;
      } else {
        suffixIconColor = ASNProjectColors.black;
            ...
            border: Border(
              left: BorderSide(
                color: widget.errorText == null
                    ? ASNProjectColors.black
                    : ASNProjectColors.red,
              ),
            ),
          ),
          child: Padding(
